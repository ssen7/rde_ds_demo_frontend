...
- **Session state**: Uses `st.session_state.last_uploaded` to track uploads and prevent duplicate processing; `st.session_state.just_deleted` prevents auto-refresh race conditions after deletion
